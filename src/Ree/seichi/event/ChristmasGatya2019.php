...
class ChristmasGatya2019
{
    ...
    const CHRISTMAS = "Christmas_2019";
    const PICKAXE = 201901;
    const AXE = 201902;
    const SHOVEL = 201903;
    const SWORD = 201904;
    const HOE = 201905;
    ...
    public static function onGatya(Player $p): bool
    {
        ...
        switch ($rand) {
            case $rand > 0 && $rand < 5:
                Server::getInstance()->broadcastMessage("§b" . $p->getName() . "§rさんが§cChrist§amas§aReef§eTool§rを引きました");
            ...
            case 5:
                Server::getInstance()->broadcastMessage("§b" . $p->getName() . "§rさんが§aChrist§cmas§aReef§eTool§rを引きましたwww");
                $webhook = ReefAPI::getWebhook();
                $content = new Content();
